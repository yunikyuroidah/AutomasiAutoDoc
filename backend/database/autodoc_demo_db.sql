...
--
-- Host: localhost:3306
-- Generation Time: Jan 25, 2026 at 06:16 PM
...
(1, 1, 'PAKET PENGADAAN DUMMY', 'DUMMY-RUP-001', '34609000.00', '2025-10-31', '2025-11-04', 1, 'DPP-DUMMY-001');
...
(1, 'OBJEK DUMMY FIKTIF', '2025-11-04');
...
(1, 1, 'PENERIMA DUMMY / CV FIKTIF', 'BANK DUMMY', '00.000.000.0-000.000', '0000000000', '2025-11-04', '4505000.00', 1, 1, 1);
...
(1, 1, 'November 2025', 'BELANJA DUMMY', 'PROGRAM DUMMY', 'KEGIATAN FIKTIF UNTUK TESTING', 'SUB KEGIATAN FIKTIF UNTUK TESTING', '2.08.07.2.01.0004.5.1.02.01.0052', 'SUMBER DANA DUMMY', 1, 1, 1);
...
(1, 1, 'TUJUAN UNIT DUMMY', 'ASAL UNIT DUMMY', '2025-11-06', 'ND/DUMMY/001', 'Penting', 'PERIHAL DUMMY', 'KEPERLUAN DUMMY UNTUK UJI SISTEM', 'UNIT DUMMY', '80050000.00', 2025, 1);
...
(261, 1, 'Item Dummy A', 80, '30000.00', '2400000.00', 'kotak', NULL, NULL),
(262, 1, 'Item Dummy B', 85, '23000.00', '1955000.00', 'kotak', NULL, NULL);
...
(1, 1, 2025, 'KEGIATAN DUMMY UNTUK PERHITUNGAN PAJAK', '440000.00', '400000.00', '40000.00', 'NAMA DUMMY', 'JABATAN DUMMY', '000', 'BADAN USAHA DUMMY', 'ALAMAT USAHA DUMMY', '080000000000', 'JANUARI', '4095454.00', '409545.45');
...
--
ALTER TABLE `pembuat_komitmen`
  MODIFY `id_ppk` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `spesifikasi_anggaran`
  MODIFY `id_spesifikasi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=263;
